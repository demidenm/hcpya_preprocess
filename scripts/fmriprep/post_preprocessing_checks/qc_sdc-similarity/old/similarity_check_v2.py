...
# run similarity
sim_betcheck = similarity.image_similarity(imgfile1=brainmask_file,
                                           imgfile2=t1w_brain_fname,
...
print(round(sim_betcheck, 2), round(sim_anatfunc, 2), round(origcsf_fpcsf, 2), 
